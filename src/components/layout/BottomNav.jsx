...
const BottomNav = ({ activeTab, onTabChange }) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 bg-white/[0.04] backdrop-blur-xl border-t border-white/[0.06]">
      <div className="max-w-md mx-auto px-6 h-16 flex justify-between items-center">
        {tabs.map((tab) => {
          ...
          return (
            ...
            >
              {isActive && (
                <span className="absolute -top-0.5 w-1.5 h-1.5 bg-teal-400 rounded-full shadow-lg shadow-teal-400/50"></span>
              )}
